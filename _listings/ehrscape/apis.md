...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/template/master/_listings/ehrscape/apis.md
...
- name: Ehr Scape Electronic Health Record APIs - Gets all template ids.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/template/master/_listings/ehrscape/template-get-openapi.md
- name: Ehr Scape Electronic Health Record APIs - Uploads an operational template.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/template/master/_listings/ehrscape/template-post-openapi.md
- name: Ehr Scape Electronic Health Record APIs - Deletes an existing OpenEHR template.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/template/master/_listings/ehrscape/templatetemplateid-delete-openapi.md
- name: Ehr Scape Electronic Health Record APIs - Loads an OpenEhr web template.
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/template/master/_listings/ehrscape/templatetemplateid-get-openapi.md
- name: Ehr Scape Electronic Health Record APIs - Returns an example of data values
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/template/master/_listings/ehrscape/templatetemplateidexample-get-openapi.md
x-common:
- type: x-api-gallery
